/**
  ...
  `validateProjectPath` from: https://github.com/vercel/next.js/blob/canary/packages/create-next-app/index.ts
*/
...
export const validateProjectPath = (projectName: string): Validation => {
